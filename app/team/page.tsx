  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-16">
      ...
      <div className="prose prose-invert max-w-none space-y-4 text-white/80">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">Leadership</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">Creative Team</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">Join Us</h2>
        <p>
        ...
        <a href="/contact" className="inline-block mt-4 px-5 py-3 rounded bg-pb-gold text-pb-black font-semibold">
          Get in Touch
        </a>
      </div>
    </section>
