export default function AboutPage() {
  return (
    <div className="min-h-screen bg-pb-black pt-20 page-transition">
      ...
      <h1 className="text-4xl font-bold mb-6">About Pulsebeat Global</h1>
      <div className="prose prose-invert max-w-none space-y-4 text-white/80">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">What Sets Us Apart</h2>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">Join the Movement</h2>
        <p>
